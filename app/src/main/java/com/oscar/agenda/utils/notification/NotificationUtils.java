package com.oscar.agenda.utils.notification;
...
import com.oscar.agenda.exception.NotificationException;
...
public class NotificationUtils {
    ...
    public static void sendNotification(NotificacionInfo info) throws NotificationException {
        ...
        Integer icon         = info.getIcon()!=null?info.getIcon():R.mipmap.ic_launcher;
