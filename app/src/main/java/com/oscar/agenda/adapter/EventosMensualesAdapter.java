 ...
 */
public class EventosMensualesAdapter extends RecyclerView.Adapter<EventosMensualesAdapter.EventoViewHolder> implements View.OnClickListener {
    ...
    public static class EventoViewHolder extends RecyclerView.ViewHolder {
        ...
        public EventoViewHolder(View v) {
            super(v);
            titulo          = (TextView) v.findViewById(R.id.nombreEvento);
            fechaHora       = (TextView)v.findViewById(R.id.fechaHoraEvento);
        }
    }
     ...
     */
    public EventosMensualesAdapter(List<EventoVO> items) {
        this.items       = items;
    }
    ...
    public EventoViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.detalle_eventos_mensuales, viewGroup, false);
